...
## 6. Content Policy and Acceptable Use
Your use of the service must comply with the Content Policy. The Content Policy defines prohibited content and conduct and is incorporated by reference into these Terms. Violations may result in removal of content or suspension of access.

## 7. Third-Party Services
The service relies on third-party providers such as Google Firebase and Expo for hosting, storage, authentication, and notifications. Their terms and policies may apply.

## 8. Termination
The operator may suspend or terminate access if you violate these Terms or misuse the service. You may stop using the app at any time.
